...
export class InputManager {
  ...
  static _initTouch() {
    ...
    touch.on(EVENT_TOUCHSTART, (event) => this._handleInputEventTouch(event, this._onPointerDown.bind(this)));
    touch.on(EVENT_TOUCHMOVE, (event) => this._handleInputEventTouch(event, this._onPointerMove.bind(this)));
    touch.on(EVENT_TOUCHEND, (event) => this._handleInputEventTouch(event, this._onPointerUp.bind(this)));
    touch.on(EVENT_TOUCHCANCEL, (event) => this._handleInputEventTouch(event, this._onPointerUp.bind(this)));
  }
  ...
  static _handleInputEventTouch(event, callback) {
    event.event.preventDefault();
    callback(event);
  }
