...
export class SceneManager {
  ...
  static resize() {
    ...
    // console.log(this.currentScene, this.addtiveScenes);
    this.addtiveScenes.forEach((scene) => scene.resize());
  }

  static updateCoin() {
    this.currentScene?.updateCoin();
    this.addtiveScenes.forEach((scene) => scene.updateCoin());
  }

  static disableMusic() {
    this.currentScene?.disableMusic();
    this.addtiveScenes.forEach((scene) => scene.disableMusic());
  }

  static enableMusic() {
    this.currentScene?.enableMusic();
    this.addtiveScenes.forEach((scene) => scene.enableMusic());
  }
