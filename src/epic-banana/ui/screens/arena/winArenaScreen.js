...
export const WinArenaScreenEvent = Object.freeze({
  ButtonClaimClicked: "buttonClaimClicked",
});


export class WinArenaScreen extends UIScreen {
  constructor() {
    super(GameConstant.SCREEN_ARENA_WIN);
  ...
  _initBody() {
    this.panel = ObjectFactory.createImageElement("layout-vic", {
      anchor: new Vec4(
  ...
  _initHeader() {
    this.header = ObjectFactory.createImageElement("ribbon", {
  ...
  _onTapButtonClaim() {
    ...
    config.onFinished = () => {
      ...
      this.fire(WinArenaScreenEvent.ButtonClaimClicked);
